  ...
  return (
    <div className="fixed bottom-4 right-4 bg-white border-2 border-gray-800 rounded-lg shadow-2xl p-4 w-96 max-h-96 overflow-y-auto z-50">
      <div className="flex justify-between items-center mb-3 border-b pb-2">
        <h3 className="font-bold text-lg">🛡️ Debug JWT Claims</h3>
        <button
      ...
      <div className="space-y-2 text-sm">
        ...
        <details className="mt-2">
          <summary className="cursor-pointer font-semibold text-xs text-gray-600">All Claims (click to expand)</summary>
