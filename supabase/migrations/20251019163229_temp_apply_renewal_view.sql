-- Temporary migration to add renewal_reminders view
-- This creates the view needed for the RenewalCalendar component

-- First, drop the view if it exists to avoid conflicts
DROP VIEW IF EXISTS renewal_reminders;
...
ORDER BY ip.end_date ASC, ip.created_at DESC;
...
-- Output confirmation
SELECT 'renewal_reminders view created successfully' as status;