-- GUARDIAN AI CRM - AGGIORNAMENTO SISTEMA PRICING A 6 LIVELLI
...
-- PRICING ASSICURAZIONI (6 LIVELLI)
...
(
  ...
  '["2.000 clienti", "500 polizze gestite", "8.000 email/mese", "800 WhatsApp/mese", "200 SMS/mese", "8GB storage documenti", "Automazioni avanzate", "Integrazioni IVASS", "Report avanzati", "Supporto prioritario"]'::jsonb,
...
(
  ...
  '["5.000 clienti", "1.000 polizze gestite", "20.000 email/mese", "2.000 WhatsApp/mese", "500 SMS/mese", "15GB storage documenti", "Multi-compagnia avanzata", "API personalizzate limitate", "Dashboard personalizzate", "Supporto telefonico prioritario"]'::jsonb,
...
(
  ...
  '["15.000 clienti", "3.000 polizze gestite", "50.000 email/mese", "5.000 WhatsApp/mese", "1.200 SMS/mese", "50GB storage documenti", "Multi-compagnia completa", "API personalizzate complete", "White label parziale", "Integrazioni enterprise", "Account manager dedicato"]'::jsonb,
...
(
  ...
  '["25.000 clienti", "5.000 polizze gestite", "100.000 email/mese", "8.000 WhatsApp/mese", "2.000 SMS/mese", "100GB storage documenti", "White label completo", "Multi-agenzia", "Integrazioni enterprise complete", "SLA garantito 99.9%", "Supporto dedicato 24/7"]'::jsonb,
...
(
  ...
  '["Clienti illimitati", "Polizze illimitate", "Email illimitate", "WhatsApp illimitati", "SMS illimitati", "Storage illimitato", "Sviluppo personalizzato completo", "Hosting dedicato privato", "Integrazioni custom illimitate", "White label 100% personalizzato", "Team di sviluppo dedicato", "Supporto 24/7 con SLA <1h", "Formazione avanzata inclusa", "Consulenza strategica mensile", "Backup e disaster recovery dedicato"]'::jsonb,
  '{"clients": -1, "policies": -1, "emails_month": -1, "whatsapp_month": -1, "sms_month": -1, "storage_gb": -1, "users": -1}'::jsonb,
  false
);

-- PRICING MARKETING (6 LIVELLI)
INSERT INTO vertical_pricing_tiers (
  account_type,
  tier_name,
  tier_level, 
...
(
  ...
  '["100 clienti", "25 progetti attivi", "5 campagne simultanee", "5.000 email/mese", "5 landing page", "1GB storage", "Analytics base", "Supporto email"]'::jsonb,
...
(
  ...
  '["1.000 clienti", "200 progetti attivi", "30 campagne simultanee", "25.000 email/mese", "30 landing page", "10GB storage", "A/B testing avanzato", "ROI tracking dettagliato", "Automazioni email avanzate", "Report personalizzati"]'::jsonb,
...
(
  ...
  '["3.000 clienti", "750 progetti attivi", "75 campagne simultanee", "75.000 email/mese", "75 landing page", "30GB storage", "A/B testing avanzato", "Multi-channel campaigns", "Conversion tracking avanzato", "Dashboard personalizzate", "White label parziale", "Account manager dedicato"]'::jsonb,
...
(
  ...
  '["7.500 clienti", "1.500 progetti attivi", "150 campagne simultanee", "150.000 email/mese", "150 landing page", "75GB storage", "White label completo", "Multi-agency", "API personalizzate complete", "Integrazioni enterprise", "SLA garantito 99.9%", "Supporto prioritario 24/7"]'::jsonb,  
...
(
  ...
  5590.00,
  'Soluzione personalizzata con servizi dedicati',
  '["Clienti illimitati", "Progetti illimitati", "Campagne illimitate", "Email illimitate", "Landing page illimitate", "Storage illimitato", "Sviluppo personalizzato completo", "Hosting dedicato privato", "Integrazioni custom illimitate", "White label 100% personalizzato", "Team di sviluppo dedicato", "Supporto 24/7 con SLA <1h", "Consulenza strategica settimanale", "Formazione avanzata team", "Backup e disaster recovery dedicato"]'::jsonb,
...
-- ===================================================================
-- 4. VIEW PER QUERY PRICING OTTIMIZZATE
-- ===================================================================
...
-- ===================================================================
-- 5. COMMENTS PER DOCUMENTAZIONE
-- ===================================================================

COMMENT ON TABLE vertical_pricing_tiers IS 'Pricing tiers per account types verticali con 6 livelli';
...
SELECT 
  ...
  is_popular
FROM vertical_pricing_tiers 
WHERE account_type IN ('insurance_agency', 'marketing_agency')
ORDER BY account_type, tier_level;