          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 relative">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">Perfetto per iniziare</p>
                <div className="mb-6">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-center">
                  ...
                  <span>Fino a 1.000 contatti</span>
                </li>
                <li className="flex items-center">
                  <CheckCircleIcon className="w-5 h-5 text-green-500 mr-3" />
                  <span>Automazioni AI di base</span>
                </li>
                <li className="flex items-center">
                  <CheckCircleIcon className="w-5 h-5 text-green-500 mr-3" />
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 relative border-2 border-blue-500">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">Per business in crescita</p>
                <div className="mb-6">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-center">
                  <CheckCircleIcon className="w-5 h-5 text-green-500 mr-3" />
                  <span>Fino a 10.000 contatti</span>
                </li>
                <li className="flex items-center">
                  <CheckCircleIcon className="w-5 h-5 text-green-500 mr-3" />
                  <span>Automazioni AI avanzate</span>
                </li>
                <li className="flex items-center">
                  <CheckCircleIcon className="w-5 h-5 text-green-500 mr-3" />
                  <span>Meeting e video call integrati</span>
                </li>
                <li className="flex items-center">
                  <CheckCircleIcon className="w-5 h-5 text-green-500 mr-3" />
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 relative">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">Soluzione su misura</p>
                <div className="mb-6">
