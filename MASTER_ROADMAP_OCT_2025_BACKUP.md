...
Steps:
  1. Predict renewal probability (RiskEngine)
  2. Personalized email (EmailGenius)
...
Steps:
  1. Fraud detection (RiskEngine)
  2. Document validation
  3. Status communication (Email + WhatsApp)
  4. Priority routing
2.4 Template: Cross-Sell Intelligente (1h)
text
Trigger: policy_renewal_completed
Steps:
  1. Opportunity analysis (deal-predictor)
