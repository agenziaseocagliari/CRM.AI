...
CREATE INDEX IF NOT EXISTS idx_insurance_policies_policy_type ON insurance_policies (policy_type);
...
CREATE POLICY IF NOT EXISTS "Users can view their organization's policies" ON insurance_policies FOR
...
CREATE POLICY IF NOT EXISTS "Users can create policies for their organization" ON insurance_policies FOR
INSERT
    TO public
WITH
    CHECK (
...
CREATE POLICY IF NOT EXISTS "Users can update their organization's policies" ON insurance_policies FOR
...
CREATE POLICY IF NOT EXISTS "Users can delete their organization's policies" ON insurance_policies FOR DELETE TO public USING (
    organization_id IN (
        SELECT organization_id
        FROM profiles
        WHERE
