...
AND table_name IN ('dashboard_opportunities', 'dashboard_events', 'form_submissions')
ORDER BY table_name;
...
SELECT 
    'VIEWS CREATED: ' || COUNT(*) FILTER (WHERE table_type = 'VIEW') AS views,
    'TABLES AVAILABLE: ' || COUNT(*) FILTER (WHERE table_type = 'BASE TABLE') AS tables,
