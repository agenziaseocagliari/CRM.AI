-- Fix: Add missing consume_credits_rpc function
-- This function is required by the FormMaster Edge Function
...
-- Add missing action types that are used by the AI agents
