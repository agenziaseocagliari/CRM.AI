  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-lg max-w-6xl max-h-[90vh] overflow-y-auto">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-bold">ðŸ” JWT Session Diagnostics</h2>
        {onClose && (
          <button
            onClick={onClose}
      ...
      {!diagnostics.hasUserRole && diagnostics.isValid && (
        <div className="mb-6 p-4 bg-yellow-50 border-2 border-yellow-500 rounded-lg">
          ...
          >
            ðŸ”„ Esegui Logout Profondo e Pulizia
          </button>
        </div>
      )}
      ...
      {diagnostics.errors.length > 0 && (
        <div className="mb-4 p-4 bg-red-50 border-l-4 border-red-500 rounded">
          <h3 className="font-bold text-red-800 mb-2">ðŸš¨ Errori</h3>
          <ul className="list-disc list-inside space-y-1">
      ...
      {diagnostics.claims && (
        <div className="mb-4">
          <h3 className="font-bold mb-2">ðŸ“‹ JWT Claims</h3>
      ...
      <div className="mb-4">
        <div className="flex justify-between items-center mb-2">
          <h3 className="font-bold">ðŸ”‘ Token Raw</h3>
          <button
