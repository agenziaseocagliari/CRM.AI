...
export const PublicPricingPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <SEOHead 
        title="Prezzi Guardian AI CRM - Piani Tariffari Trasparenti"
        description="Scopri i piani tariffari di Guardian AI CRM. Prova gratuita 14 giorni, piani scalabili per agenzie assicurative e marketing. Prezzi trasparenti senza sorprese."
        keywords="prezzi CRM, tariffe CRM AI, costi CRM assicurazioni, prezzi CRM marketing, piani CRM"
        canonical="https://guardianacrm.com/pricing"
      />
      <PublicHeader />
